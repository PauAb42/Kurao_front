            ...
            <tbody>
              {loading ? (
                ...
                <motion.tr key={p.id} className="pts-row" initial={{ opacity:0, x:-8 }} animate={{ opacity:1, x:0 }} transition={{ delay: idx * 0.03 }} style={{ borderBottom:'1px solid #EEF3FA' }}>
                  ...
                  <td style={{ padding:'12px 16px' }}><span style={{ fontWeight:700, color:'#0B1F3A', fontSize:13 }}>{p.nombre} {p.apellidos}</span></td>
                  ...
                  <td style={{ padding:'12px 16px' }}><span style={{ fontSize:11, fontWeight:800, color:'#DC2626', background:'#FEE2E2', padding:'2px 8px', borderRadius:7 }}>{p.tipo_sangre}</span></td>
